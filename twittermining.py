# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 17:21:55 2020
...
with open("D:\STUDY\Excelr Assignment\Assignment 12 - Text Mining\stop.txt","r") as stp:
    stopword = stp.read().split("\n")
    
stopword =stopword[36:]
pos_words = ' '.join([w for w in srt_words if w in stopword])
